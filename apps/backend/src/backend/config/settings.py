"""
Configuration settings for the Phoenix Template.
...
class Settings(BaseSettings):
    ...
    # Application
    app_name: str = Field(default="Phoenix Template", env="APP_NAME")
    ...
    langsmith_project: str = Field(default="phoenix-template", env="LANGSMITH_PROJECT")
    
    # Default AI Models
    default_content_model: str = Field(default="gpt-3.5-turbo", env="DEFAULT_CONTENT_MODEL")
    default_research_model: str = Field(default="gpt-3.5-turbo", env="DEFAULT_RESEARCH_MODEL")
